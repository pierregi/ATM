...
<?php echo form_open('artiste/recherche',array('class'=>'form-inline')); ?>
    ...
    <?php echo $errorDate;?>
        ...
        <input type="date" id="date" class="form-control" placeholder="Date" style="margin : 0 5px;" name="date" min="2017-11-07" max="2017-12-30" value="<?php echo( set_value('date',"",TRUE));?>"required><span style="color:grey;">*&nbsp;</span>
...
<?php 
  $image_properties = array(
        'src'   => "/static/img/crying_face.png",
        'width' => '20',
        'height'=> '20',
        'style' => 'margin-right : 8px;');
?>
Désolé, vous avez déjà un concert ce jours là. <?php echo img($image_properties); ?>
<?php elseif(!$empty && (count($salle)>0)): ?>
